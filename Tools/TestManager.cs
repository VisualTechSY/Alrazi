...
namespace Alrazi.Tools
{
    public class TestManager
    {
        ...
        public static List<TestPortageIndividualPlanVM> GetTestPortageIndividualPlanVM()
        {
...
"يرسم المعين مقلدا ",
            ...
            return testPortageIndividualPlanVMs;
        }



        public static List<AchievementTestsSchoolReadinessQSVM> GetAchievementTestsSchoolReadinessQS()
        {

            List<AchievementTestsSchoolReadinessQSVM> testPortageIndividualPlanVMs = new List<AchievementTestsSchoolReadinessQSVM>();

            testPortageIndividualPlanVMs.AddRange(
            [
    // مهارات ما قبل القراءة
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل القراءة",
        TitleGroup = "المفاهيم",
        Quastions = [
            "أن يسمى أو يختار صورة فوق – تحت",
            "أن يسمى أو يختار صورة داخل - خرج",
            "أن يسمى أو يختار صورة مفتوح - مغلق",
            "أن يسمى أو يختار صورة قليل - كثير",
            "أن يسمى أو يختار صورة أمام - خلف",
            "أن يسمى أو يختار صورة المنتصف"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل القراءة",
        TitleGroup = "التمييز البصري",
        Quastions = [
            "يضع 3 قطع ليكمل لوحة الأشكال المكونة من 4 قطع",
            "يقوم بتركيب لوحة بازل مكونة من أربع أجزاء",
            "أن يذكر الجزء الناقص من صورة مرسومة",
            "أن يجمع صورتين بينهما علاقة (حذاء – شراب) 4 على الأقل",
            "أن يسمى أو يختار الصورة المختلفة شكلاً من بين 4 صور",
            "أن يسمى أو يختار الصورة المختلفة في الفئة من بين 4 صور",
            "يسمي أو يختار الألوان: الأحمر، الأصفر، الأخضر...الخ",
            "أن يصنف صور الأشياء في مجموعات: حيوانات، مواصلات، أطعمة",
            "أن يصنف صور الحيوانات: أليفة – غير أليفة",
            "أن يصنف صور الأطعمة: فاكهة – خضراوات",
            "أن يذكر ما في الصورة من أحداث"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل القراءة",
        TitleGroup = "تسلسل الأحداث",
        Quastions = [
            "أن يرتب أحداث قصة من 4 كروت",
            "أن يحكي قصة من 4 كروت",
            "أن يحكي قصة من الذاكرة"
        ]
    },
    ...
    {
        MainGroup = "التسمية",
        TitleGroup = "تسمية الأفعال",
        Quastions = [
            "يسمي الأفعال التي تعرض عليه (على الأقل من 4 – 6 أفعال)"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "التسمية",
        TitleGroup = "تسمية الأدوات والأفعال",
        Quastions = [
            "يسمي الأداة: كوب / الفعل: نشرب فيه",
            "يسمي الأداة: نظارة / الفعل: نشوف بيها",
            "يسمي الأداة: طبق / الفعل: نأكل فيه",
            "يسمي الأداة: مقص / الفعل: نقص بيه",
            "يسمي الأداة: سكينة / الفعل: نقطع بيه",
            "يسمي الأداة: قلم / الفعل: نكتب بيه"
        ]
    },
    ...
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات القراءة",
        TitleGroup = "التمييز والقراءة",
        Quastions = [
            "أن يذكر الحروف الأبجدية بالترتيب من الذاكرة",
            "أن يسمى أو يشير إلى الحروف المكتوبة أمامه",
            "أن يذكر كلمتين تبدأ بحرف معين يُطلب منه (أ / ب / س / ج)"
        ]
    },
    ...
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل الحساب",
        TitleGroup = "المفاهيم",
        Quastions = [
            "أن يسمى أو يختار صورة فاضي / مليان",
            "أن يسمى أو يختار صورة قليل / كثير",
            "أن يسمى أو يختار صورة كبير / صغير",
            "أن يسمى أو يختار صورة طويل / قصير",
            "أن يسمى أو يختار صورة قبل / بعد",
            "أن يسمى أو يختار صورة الأول / الأخير"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        ...
        TitleGroup = "التمييز البصري",
        Quastions = [
            "أن يصنف الصور في مجموعات حسب الشكل – اللون",
            "أن يصنف الصور في مجموعات حسب الحجم",
            "يرتب صور أشياء حسب الحجم",
            "يرتب صور أشياء حسب الطول"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل الحساب",
        TitleGroup = "مهارات العد",
        Quastions = [
            "يعد الأشياء مقلداً حتى 5 أشياء",
            "أن يعد شفهياً مقلداً من 1 : 10",
            "يلتقط 5 أشياء وفقًا للقيمة المطلوبة منه"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل الحساب",
        TitleGroup = "مهارات الحساب",
        Quastions = [
            "يذكر الأرقام من الذاكرة",
            "يسمي أو يشير إلى الأرقام المكتوبة أمامه من 0 – 1"
        ]
    },
    ...
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل الكتابة",
        TitleGroup = "المفاهيم",
        Quastions = [
            "يضع أربع حلقات في وتد",
        "يفتح علبة ليرى ما فيها (تحسب الدرجة إذا استطاع إدارة الغطاء)",
            "يبني جسر مكون من 3 مكعبات",
            "يثني الورقة إلى نصفين على سبيل التقليد",
            "يكور كرات من الصلصال"
        ]
    },
    new AchievementTestsSchoolReadinessQSVM
    {
        MainGroup = "مهارات ما قبل الكتابة",
        TitleGroup = "مهارات مسك القلم",
        Quastions = [
            "أن يلون داخل إطار شكل",
            "أن يقلد الخطوط (خط رأسي، دائرة، علامة +، حرف V)",
            "أن يرسم الأشكال الهندسية مثلث – دائرة – مربع – مستطيل",
            "أن يسير بالقلم داخل متاهة بسيطة",
            "أن يكمل جزء ناقص بالرسم في صورة",
            "أن يقص خط مستقيم",
            "أن يقص أشكال بسيطة (مستطيل - مربع)",
            "أن يقص صورة من مجلة",
            "يكتب أو ينسخ الأرقام التي أمامه",
            "أن ينسخ الحروف الأبجدية التي أمامه",
            "أن يكتب اسمه"
        ]
    }
]);
        ...
        public static List<string> GetAchievementTestArabic(int testId)
        {
            switch (testId)
            {
                //1 المستوى الأول
...
{
    "رسم الخطوط",
    "اتباع الطريقة الصحيحة لمسك القلم",
    "قراءة الحروف الهجائية",
    "كتابة الحروف الهجائية",
    "كتابة الحروف بأشكالها و أوضاعها المختلفة",
    "التمييز نطقاً بين الحروف المتقاربة في الشكل أو الصوت",
    "التمييز كتابة بين الحروف المتقاربة في الشكل أو الصوت",
    "قراءة الحروف مع الحركات",
    "كتابة الحروف مع الحركات",
    "كتابة الحروف بالمد القصير والمد الطويل"
};
                ...
                case 11:
                    return new List<string>()
{
    "التعرف على أحرف المد",
    "التعرف على الأحرف اللثوية",
    "تحليل كلمة الى حروف",
    "تركيب حروف الى كلمة",
    "قراءة وكتابة كلمات : من حرفين/ ثلاثة أحرف / أربعة أحرف",
    "قراءة وكتابة جمل : من كلمتين / ثلاث كلمات / أربعة كلمات",
    "قراءة التنوين بأنواعه الثلاثة",
    "كتابة التنوين بأنواعه الثلاثة",
    "التمييز بين اللام القمرية واللام الشمسية قراءةً",
    "التمييز بين اللام القمرية واللام الشمسية كتابةً"
};
                ...
                case 20:
                    return new List<string>()
{
    "قراءة الحروف الهجائية بحركاتها",
    "التمييز بين المد والحركة",
    "التمييز بين التاء المربوطة والتاء المفتوحة",
    "التمييز بين الكلمة والجملة",
    "تحليل جملة الى عدة كلمات",
    "تركيب جملة من عدة كلمات",
    "قراءة كلمات وكتابتها بحركات",
    "قراءة جملة مكونة من عدة كلمات",
    "دخول (ال) التعريف على الكلمات",
    "ترتيب الكلمات لتصبح جملة"
};
...
{
    "ترتيب الكلمات لتصبح جملة",
    "كتابة كلمات وجمل بعد النظر اليها، ثم حجبها",
    "كتابة جمل تبدأ باللام الشمسية واللام القمرية",
    "معرفة أنواع الهمزات",
    "التمييز بين همزة الوصل وهمزة القطع",
    "المفرد والجمع",
    "معرفة أحرف الجر",
    "معرفة الفعل الماضي",
    "معرفة الفعل المضارع",
    ...
    "معرفة أسماء الإشارة"
                ...
                case 30:
                    return new List<string>()
{
    "قراءة كلمات بحركات المد القصير الثلاث وكتابتها",
    "قراءة الكلمات بحركات المد الطويل الثلاث وكتابتها",
    "قراءة الكلمات تحتوي على اشكال التنوين وكتابتها",
    "مواضع احرف الجر",
    "كتابة الكلمات كتابة صحيحة مع مراعاة ما يكون منها فوق السطر وما ينزل عنه",
    "معرفة علامات الترقيم",
    "التمييز بين الحرف والاسم والفعل",
    "معرفة الفعل الماضي",
    "معرفة الفعل المضارع",
    "معرفة فعل الامر"
};
...
{
    "معرفة التضعيف",
    "قراءة كلمات مشددة وكتابتها",
    "معرفة الالف الممدودة والالف المقصورة",
    "التدريب على الكتابة غيباً كما يملى على الطالب في زمن ملائم مع مراعاة علامات الترقيم",
    "معرفة الأحرف الجازمة",
    "معرفة الأحرف الناصبة",
    "معرفة الجملة الاسمية",
    "معرفة الجملة الفعلية",
    "قراءة نص قراءة سليمة مع الضبط",
    "المؤنث والمذكر"
};
...
{
    "الجمع والعكس",
    "الجملة الفعلية والجملة الإسمية",
    "همزة القطع وهمزة الوصل",
    "المصدر وفعله",
    "إعراب الفعل والفاعل والمفعول به",
    "إعراب المبتدا والخبر",
    "تحويل الجملة الفعلية إلى جملة اسمية والعكس",
    "التاء المربوطة والمبسوطة",
    "حالات بناء الفعل الماضي على الفتح",
    "الأحرف الناصبة والجازمة"
};
                //المستوى الخامس ب
                case 51:
                    return new List<string>()
{
    "إعراب الفعل المضارع إذا سبقه حرف ناصب او جازم",
    "تعليل الهمزة المتوسطة",
    "احرف العلة وفعل الأمر",
    "اسم الفاعل والمفعول",
    "الألف اللينة في الاسماء والأفعال",
    "المثنى وإعرابه",
    "إعراب الجموع",
